...
export default function PdfViewer({ file, onDownloadReport }: PdfViewerProps) {
  ...
  return (
    <section className="h-[40vh] md:h-auto md:flex-1 shrink-0 bg-surface-container-lowest flex flex-col overflow-hidden relative border-b md:border-b-0 border-outline-variant">
      {/* Toolbar */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center px-4 py-2.5 bg-surface border-b border-outline-variant z-10 gap-2 md:gap-0">
        <div className="flex items-center gap-2 w-full">
          ...
          <span className="text-[13px] text-on-surface font-medium truncate max-w-[160px] md:max-w-[200px]">{file.name}</span>
