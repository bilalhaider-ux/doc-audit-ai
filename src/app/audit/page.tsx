    ...
    <div className="h-screen bg-surface-container-low flex flex-col md:flex-row overflow-hidden animate-[fade-in_0.5s_ease-out] pb-16 md:pb-0">
      ...
      <div className="flex-1 flex flex-col min-w-0 min-h-0">
        ...
        <main className="flex-1 flex flex-col md:flex-row overflow-hidden relative min-h-0">
          ...
          {/* Right AI Panel */}
          <section className="flex-1 md:w-[400px] lg:w-[420px] md:flex-none border-t md:border-t-0 md:border-l border-outline-variant bg-surface flex flex-col shadow-[-4px_0_24px_rgba(0,0,0,0.02)] z-10 min-h-0">
            {/* Panel Tabs */}
