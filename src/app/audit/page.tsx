    ...
    <div className="h-screen bg-surface-container-low flex flex-col md:flex-row overflow-hidden animate-[fade-in_0.5s_ease-out] pb-16 md:pb-0">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 flex flex-col md:flex-row overflow-y-auto md:overflow-hidden relative">
          ...
          {/* Right AI Panel */}
          <section className="w-full md:w-[400px] min-h-[60vh] md:min-h-0 border-t md:border-t-0 md:border-l border-outline-variant bg-surface flex flex-col shadow-[-4px_0_24px_rgba(0,0,0,0.02)] z-10 shrink-0">
            {/* Panel Tabs */}
